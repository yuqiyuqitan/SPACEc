...
``SPACEc`` documentation uses Sphinx_ as its main documentation compiler.
...
.. _repository: https://github.com/<USERNAME>/SPACEc
.. _issue tracker: https://github.com/<USERNAME>/SPACEc/issues
.. <-- end -->
