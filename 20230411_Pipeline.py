...
from  All_functions_improved import *
...
cells_df, k_centroids = tl_neighborhood_analysis_2(data = df2, 
                           ...
                           k = k, 
                           n_neighborhoods = n_neighborhoods,  
                           calc_silhouette_score = False) # Not well working yet -> implementation is far too slow
...
cells2, ct_freq, all_freqs, pat_to_gp, neigh_num = hf_hf_cell_types_de_helper(df = cells_df, \
...
pl_plot_modules_graphical(dat1, pal = pal, cns = cns, cts = cts, save_name = 'T cell', save_path = output_dir, scale = 0.4)
