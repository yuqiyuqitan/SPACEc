...
def hf_prepare_neighborhood_df2(cells_df, patient_ID_component1, patient_ID_component2, neighborhood_column = None):
    # Spacer for output 
    print("")
    
    # Combine two columns to form unique ID which will be stored as patients column 
    cells_df['unique_ID'] = cells_df[patient_ID_component1]+'_'+cells_df[patient_ID_component2]
