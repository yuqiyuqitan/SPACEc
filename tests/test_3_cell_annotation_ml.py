...
def test_3_cell_annotation_ml():
    ...
    with TemporaryDirectory() as output_dir:
        ...
        sp.pl.pl_catplot_ad(adata_val, color = "svm_pred", # specify group column name here (e.g. celltype_fine)
        ...
        ct_perc_tab, _ = sp.pl.pl_stacked_bar_plot_ad(adata = adata_val, # adata object to use 
        ...
        sp.pl.pl_create_pie_charts_ad(adata_val,
                                color = "svm_pred", 
                                grouping = "condition", 
